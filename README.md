...
.venv/bin/python tests/run_tests.py     # kỳ vọng: 92 passed, 0 failed
```
...
IPv6 zone index & IPv4-mapped, DNS-rebinding, kiểm tra lại từng chặng redirect,
giới hạn dung lượng trang) · **E2E handlers qua `Dispatcher.feed_update`** (fake
Telegram session: /help, /ask, /ask@bot đúng/sai mention, mention trong caption,
