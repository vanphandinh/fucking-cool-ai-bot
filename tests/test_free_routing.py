"""Regression tests for B.AI-first deployment defaults on the generic router."""
...
class BaiDeploymentDefaultsTests(unittest.TestCase):
    def test_defaults_keep_qwen_limits_and_add_aurora_text_fallback_slot(self) -> None:
